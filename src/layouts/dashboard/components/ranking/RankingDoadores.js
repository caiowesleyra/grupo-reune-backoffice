...
const premios = [
  { titulo: "🥇 1º Lugar - MOTO 0KM", imagem: "/images/premios/1colocado.png" },
  { titulo: "🥈 2º Lugar - iPhone 14", imagem: "/images/premios/2colocado.png" },
  { titulo: "🥉 3º Lugar - PlayStation 5", imagem: "/images/premios/3colocado.png" },
];
          ...
          {premios.map((premio, index) => (
            <Grid item xs={12} md={4} key={index}>
              <Card sx={{ textAlign: "center", p: 2 }}>
                ...
                <img src={premio.imagem} alt={premio.titulo} style={{ width: "100%", borderRadius: 8, marginTop: 8 }} />
              </Card>
            </Grid>
          ))}
        </Grid>
